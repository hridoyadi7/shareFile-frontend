    ...
    return (
        <div className="flex flex-col items-center justify-center w-full p-2 space-y-3">
            ...
            <form className="flex flex-col items-center justify-center w-full p-2 space-y-3" onSubmit={handleEmail}>
                <input className="p-1 text-white bg-gray-800 border-2 outline-none focus:" type="email" placeholder="Email From" required onChange={e=>setEmailFrom(e.target.value)} value={emailFrom}/>
                <input className="p-1 text-white bg-gray-800 border-2 outline-none focus:" type="email" placeholder="Email To" required onChange={e=>setEmailTo(e.target.value)} value={emailTo}/>
